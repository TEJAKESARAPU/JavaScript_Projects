...
if (answer.toLowerCase() === "y") {
    const answer2 = prompt("Would you like to left or right (left/right)? ")

    if (answer2.toLowerCase() === "left" ) {
        console.log("Oops, you go to left and fall of a bridge! You lost!");
    } else {
        //right 
        console.log("Nice! You go right and approach a bridge...")
        const answer3 = prompt("Would you like to cross the bridge, or turn and find another way (cross/turn)? ");
